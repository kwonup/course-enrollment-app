...
- [x] 강의 목록 로딩 상태 처리
- [x] 강의 목록 에러 상태 처리
- [x] 신청 제출 pending 상태 처리
- [x] 신청 제출 success 상태 처리
- [x] 신청 제출 error 상태 처리
...
- [x] 다음 단계 이동 함수 작성
- [x] 이전 단계 이동 함수 작성
- [x] 특정 스텝으로 이동하는 함수 작성
- [x] 다음 단계 이동 전 현재 스텝 검증
- [x] 이전 단계 이동 시 입력 데이터 유지
- [x] 최종 제출 시 전체 데이터 검증
...
- [x] 신청 인원수 필드 구현
- [x] 참가자 명단 필드 구현
- [x] 신청 인원수 변경 시 참가자 필드 개수 동기화
- [x] 참가자 이름 입력 구현
- [x] 참가자 이메일 입력 구현
- [x] 담당자 연락처 필드 구현
- [x] 참가자 이메일 중복 검증
- [x] 단체 신청에서 개인 신청 전환 시 데이터 초기화 처리
- [x] 데이터 초기화 전 확인 대화상자 구현
...
- [x] 제출 실패 후 입력 데이터 유지
- [x] 재시도 기능 구현
- [x] `COURSE_FULL` 사용자 메시지 처리
- [x] `DUPLICATE_ENROLLMENT` 사용자 메시지 처리
- [x] `INVALID_INPUT` 필드별 에러 반영
...
- [x] 완료된 스텝 표시
- [x] 에러 발생 시 필드 시각적 강조
- [x] 에러 발생 시 첫 번째 에러 필드로 포커스 이동
- [x] 모바일 반응형 레이아웃 구현
- [x] 접근성 고려한 label 연결
- [x] 버튼 disabled 상태 명확히 표시
- [x] 빈 상태 안내 문구 작성
- [x] 로딩 skeleton 또는 spinner 구현
